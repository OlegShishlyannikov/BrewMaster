...
template <class T> static T loadu_le(const void *Ptr) { return bswap_le(loadu<T>(Ptr)); }
template <class T> static T loadu_be(const void *Ptr) { return bswap_be(loadu<T>(Ptr)); }
template <class T> static void storeu_le(void *Ptr, T const V) { storeu(Ptr, bswap_le(V)); }
template <class T> static void storeu_be(void *Ptr, T const V) { storeu(Ptr, bswap_be(V)); }
...
template <class T> static void store_le(T *Ptr, T const V) { *Ptr = bswap_le(V); }
template <class T> static void store_be(T *Ptr, T const V) { *Ptr = bswap_be(V); }
} // namespace intmem
